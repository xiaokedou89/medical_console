  ...
  <div class="canvas_box">
    ...
    <div class="canvas_main">
      ...
      <div class="canvas_button">
        ...
        <el-button type="primary" size="small" v-if="!fullScreenFlag" @click="fullScreen">{{ $t('fullScreen') }}</el-button>
...
import { getOrder, changeModelTag } from '@/api/Orders/orders'
...
.canvas_button{
  position:absolute; right:10px; top:10px; z-index:1001;width:150px
}
#canvas_center{
